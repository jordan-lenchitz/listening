...
cqt = librosa.cqt(y, sr=sr, fmin=fmin, bins_per_octave=bins_per_octave, n_bins=bins_per_octave * n_octaves)
...
freqs = librosa.cqt_frequencies(n_bins=chromagram.shape[0], fmin=fmin, bins_per_octave=bins_per_octave)

# plot it
fig, ax = plt.subplots(figsize=(12, 6))
img = librosa.display.specshow(chromagram, x_axis='time', y_axis='cqt_note', sr=sr, fmin=fmin, bins_per_octave=bins_per_octave, ax=ax)
